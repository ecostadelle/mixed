...
from ud_naive_bayes import InterpretableCategoricalNB
...
for dataset,identifier in data:
    ...
    if f1_ood:
        ...
        mssf_a = model_a.sufficiency_based_feature_importances(X_an)
        mssf_b = model_b.sufficiency_based_feature_importances(X_bn)
